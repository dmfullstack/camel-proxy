 ...
 * 2013-11-18T13:30:14.370-08:00
 * Generated source version: 2.7.7
 * 
 */
@WebServiceClient(name = "StockQuote", 
                  wsdlLocation = "src/main/webapp/WEB-INF/wsdl/stockquote.wsdl",
...
public class StockQuote extends Service {
    ...
    static {
        URL url = StockQuote.class.getResource("src/main/webapp/WEB-INF/wsdl/stockquote.wsdl");
        if (url == null) {
            url = StockQuote.class.getClassLoader().getResource("src/main/webapp/WEB-INF/wsdl/stockquote.wsdl");
        } 
        if (url == null) {
            java.util.logging.Logger.getLogger(StockQuote.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "src/main/webapp/WEB-INF/wsdl/stockquote.wsdl");
        }       
        WSDL_LOCATION = url;
    }
